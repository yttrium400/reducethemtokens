SYMBOLS_QUERY = ""  # Kotlin extraction uses direct AST traversal.
IMPORTS_QUERY = ""


def declaration_signature(source: bytes, node) -> str:
    """Return a compact Kotlin declaration without its implementation body."""
    end_byte = node.end_byte
    for child in node.children:
        if child.type in ("function_body", "class_body"):
